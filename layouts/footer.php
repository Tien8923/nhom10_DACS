<footer style="background-color: #81d742 !important;">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<ul>
					...
					<li><i class="bi bi-mailbox2"></i> nhom10@gmail.com</li>
					<li><i class="bi bi-telephone-fill"></i> 0123456789</li>
					<li><i class="bi bi-map-fill"></i> TP.Ho Chi Minh, Viet Nam</li>
	...
	<div style="background-color: #3f9609; width: 100%; text-align: center; padding: 20px;">
		© 2024 Zic Zac Group . Được thiết kế bời ZicZac. All rights reserved.
	</div>
</footer>
